...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t Prop0_cmdPropRadioDivSetup433 =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    .pNextOp = 0,
...
rfc_CMD_PROP_TX_t Prop0_cmdPropTx433 =
{
    .commandNo = 0x3801,
    .status = 0x0000,
    .pNextOp = 0,
...
rfc_CMD_PROP_RX_t Prop0_cmdPropRx433 =
{
    .commandNo = 0x3802,
    .status = 0x0000,
    .pNextOp = 0,
