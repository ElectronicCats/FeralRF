...
from feralrf.protocol import build_frame, cobs_decode, parse_frame  # noqa: F401
...
class FakeSerial:
    ...
    def queue_response(self, cmd_id: int, seq: int, payload: bytes = b"") -> None:
        # build_frame already returns COBS-encoded bytes (no trailing 0x00).
        # Append the 0x00 delimiter expected by Radio._read_response.
        self._read_buf.extend(build_frame(cmd_id, seq, payload))
        self._read_buf.append(0x00)
